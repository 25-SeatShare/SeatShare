...
class MySeatCheckActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.my_seat_check)
        ...
        // 홈으로 버튼
        val homeBtn = findViewById<TextView>(R.id.my_seat_check_back_btn)
        homeBtn.setOnClickListener {
            startActivity(Intent(this, HomeActivity::class.java))
            finish()
        }

        // 수정하기 버튼 → 다시 SeatRegistration1부터
        val editBtn = findViewById<TextView>(R.id.my_seat_check_edit_btn)
